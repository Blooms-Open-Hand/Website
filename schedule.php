...
$pageDescription =
    'Request a tour or care meeting with ' .
    $organization . '.';
                        ...
                        >
                            ...
                            <div style="padding:30px;">
                                ...
                                <p
                                    ...
                                    "
                                >
                                    A visitor submitted a new tour or
                                    care consultation request from the
                                    website.
                                </p>
                                ...
                                >
                                    ...
                                    by the Blooms Open Hand website.
                                </p>
          ...
          <div class="fade-in fade-in-delay-1">
            ...
            <div class="contact-form-card">
              ...
              <?php if ($sent): ?>
                ...
                <div
                  class="mt-5 rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-emerald-900"
                  role="status"
                >
    ...
    >
      ...
      <div
        ...
        style="
          ...
          background:linear-gradient(135deg,#2E6B8A,#6BBFA0);
          border-radius:50%;
          display:flex;
          align-items:center;
          justify-content:center;
